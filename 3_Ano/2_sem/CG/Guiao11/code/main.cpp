...
void prepareCylinder(float altura, float raio, int lados) {
	...
	for (int i = 0; i < lados; ++i) {
		...
		t[vertex*2+0] = 0.4375f + 0.09375f * sin(i * delta);
        t[vertex*2+1] = 0.28125f + 0.09375f * cos(i * delta);
		...
		t[vertex*2+0] = 0.4375f + 0.09375f * sin((i+1) * delta);
        t[vertex*2+1] = 0.28125f + 0.09375f * cos((i+1) * delta);

		// corpo
		// O eixo s vai de 0 a 1 ao longo da circunferência
        // O eixo t vai de 0.375 (baixo) a 1.0 (cima)
        float s_i   = (float) i      / lados;
        float s_i1  = (float)(i + 1) / lados;
		...
		v[vertex*3 + 1] = -altura/2.0f;
		v[vertex*3 + 2] = raio * cos( (i+1) * delta);
		t[vertex*2 + 0] = 0.8125f + 0.09375f * sin((i+1) * delta);
        t[vertex*2 + 1] = 0.28125f + 0.09375f * cos((i+1) * delta);
		...
		v[vertex*3 + 1] = -altura/2.0f;
		v[vertex*3 + 2] = raio * cos( i * delta);
		t[vertex*2 + 0] = 0.8125f + 0.09375f * sin(i * delta);
		t[vertex*2 + 1] = 0.28125f + 0.09375f * cos(i * delta);
