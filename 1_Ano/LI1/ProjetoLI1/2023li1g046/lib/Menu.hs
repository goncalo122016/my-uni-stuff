...
infoBox True = pictures [
    translate 0 0 $ color (greyN 0.43) $ rectangleSolid 900 700,
    translate 0 0 $ color black $ rectangleWire 900 700,
    translate (-313) 280 $ scale 0.35 0.35 $ color black $ text "Informacoes Importantes /!\\",
    translate (-313) 290 $ color black $ text "______",
    translate (-338) 150 $ scale 0.3 0.3 $ color white $ text "No ambito da UC de Laboratorios",
    translate (-330) 105 $ scale 0.3 0.3 $ color white $ text "de Informatica I foi nos proposta",
    translate (-315) 65 $ scale 0.3 0.3 $ color white $ text "a realizacao de um remake do",
    translate (-350) 25 $ scale 0.3 0.3 $ color white $ text "famoso jogo \"Donkey Kong\" (1981).",

    translate (-305) (-90) $ scale 0.3 0.3 $ color white $ text "Este Jogo foi desenvolvido por:",
    translate (-186) (-130) $ scale 0.2 0.2 $ color white $ text "Goncalo Castro LEI a107337",
    translate (-157) (-170) $ scale 0.2 0.2 $ color white $ text "Luis Felicio LEI a106913",    
    translate (-150) (-300) $ scale 0.2 0.2 $ color (greyN 0.2) $ text "Pressiona 'Q' para fechar"
  ]
...
main :: IO ()
main = do p1 <- loadBMP "images/out.bmp"
