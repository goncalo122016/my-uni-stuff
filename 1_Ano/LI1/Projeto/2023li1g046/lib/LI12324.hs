...
module LI12324 (
    -- * Tipos de dados
    -- ** Básicos
    Posicao, Tamanho,Velocidade, Tempo, Hitbox, Direcao(..), Semente,
    -- ** Mapas
...
data Bloco
  = EscadaIncompleta -- Igual a escada em imagem mas os personagens não podem mover-se verticalmente nestas
  ...
  | Alcapao       -- ^ Bloco que desaparece após ser atravessado pelo jogador (ALÇAPÃO)
  | Vazio       -- ^ Espaço (VAZIO)
...
-- | Tamanho de uma 'Personagem'
type Tamanho = (Double, Double)
